...
from DLIP.data.base_classes.instance_seg_detectron.base_inst_seg_detectron import BaseInstanceSegmentationDectronDataset


class DetectronInstanceSegmentationDataModule(BasePLDataModule):
    def __init__(
        self,
        root_dir: str,
        batch_size = 1,
        ...
        **kwargs
        ...
        self.labeled_train_dataset: BaseInstanceSegmentationDectronDataset = None
    ...
    def _init_datasets(self):
        self.labeled_train_dataset = BaseInstanceSegmentationDectronDataset(
        ...
        self.val_dataset = BaseInstanceSegmentationDectronDataset(
            root_dir=self.train_labeled_root_dir, 
        ...
        self.unlabeled_train_dataset = BaseInstanceSegmentationDectronDataset(
        ...
        self.test_dataset = BaseInstanceSegmentationDectronDataset(
