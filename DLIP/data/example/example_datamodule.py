...
class ExamplePLDatamodule(BasePLDataModule):
    ...
    def __init__(
        ...
        initial_labeled_size: float = 0.5,
        num_workers: int = 5,
        ...
        self.labeled_train_dataset = ExampleDataset(num_of_images=100, labels_available=True)
        ...
        for _ in range(int(len(self.labeled_train_dataset) * (1 - self.initial_labeled_size))):
